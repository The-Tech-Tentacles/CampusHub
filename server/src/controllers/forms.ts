...
// NOTE: createForm moved to faculty controller (faculty/index.ts)
...
// NOTE: getMyForms, getFormSubmissions, and deleteForm moved to faculty controller (faculty/index.ts)
